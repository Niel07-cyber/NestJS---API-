...
async function seed() {
  ...
  await dataSource.query(`
    ...
    ('${readerUserId}', 'reader_user', 'reader', 'password123'),

    ('${writerUserId}', 'writer_user', 'writer', 'password123'),

    ('${moderatorUserId}', 'moderator_user', 'moderator', 'password123'),

    ('${adminUserId}', 'admin_user', 'admin', 'password123')
